...
class PopupService implements PopupInterface
{
    public function index()
    {

        $Popups = Popup::where('user_id', auth('user')->user()->id)->get();

        return view('pages.popups.index')->with(['Popups'=> $Popups , 'alertMessages'=> checkAndDisplayAlert()]);
    ...
    public function create($attribute)
    {
        ...
        return redirect('popups/index')->with('message', 'created succesfully!');
